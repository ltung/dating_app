...
class ImageSourceSheet2 extends StatelessWidget {
  // Constructor
  ImageSourceSheet2({required this.onImageSelected});
  ...
  Future<void> selectedImage(BuildContext context, String messageType, File? image) async {
    // init i18n
              ...
              children: <Widget>[
                ...
                TextButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    selectedImage(context, 'image', File(pickedFile.path));
                  },
                ),
                ...
                TextButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    if (pickedFile == null) return;
                    //selectedImage(context, 'video', File(pickedFile.path));
