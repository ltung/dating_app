...
import 'package:dating_app/screens/chat_screen2.dart';
...
class ConversationsTab2 extends StatelessWidget {
  // Variables
                      ...
                      child: ListTile(
                        ...
                        onTap: () async {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => ChatScreen2(user: user)));
                        },
                      ),
                    );
                  }),
