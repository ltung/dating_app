...
class CityMaintenance2Dialog extends StatefulWidget {
  // Variables
  ...
  CityMaintenance2Dialog(
      {Key? key, required this.firestore, required this.user})
      : super(key: key);

  //CityMaintenanceDialog({required this.flaggedUserId});

  @override
  _CityMaintenance2DialogState createState() => _CityMaintenance2DialogState();
}

class _CityMaintenance2DialogState extends State<CityMaintenance2Dialog> {
  // Variables
