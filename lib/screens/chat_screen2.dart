...
import 'package:dating_app/widgets/chat_message2.dart';
import 'package:dating_app/widgets/image_source_sheet.dart';
import 'package:dating_app/widgets/video_source_sheet.dart';
import 'package:dating_app/widgets/audio_source_sheet.dart';
...
class ChatScreen2 extends StatefulWidget {
  ...
  ChatScreen2({required this.user});
...
class _ChatScreen2State extends State<ChatScreen2> {
  ...
  Future<void> _getVideo() async {
    await showModalBottomSheet(
        ...
        builder: (context) => VideoSourceSheet(
              onImageSelected: (image) async {
                if (image != null) {
                  await _sendMessage(type: 'video', imgFile: image);
                  // close modal
                  Navigator.of(context).pop();
                }
              },
  ...
  Future<void> _sendMessage(
    ...
    await _messagesApi.saveMessage(
        ...
        // current user photo
        userFullName: UserModel().user.userFullname,
          ...
          if (!snapshot.hasData)
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final String messageType = msg[MESSAGE_TYPE];
